...
public class MainFrame extends BaseFrame implements ActionListener, Observer {
	...
	private static final String COMMAND_OPEN = "打开pcap文件";
	private static final String COMMAND_EXIT = "退出";
	private static final String COMMAND_ABOUT = "关于";
	private static final String COMMAND_OPEN_RECENT = "重新打开关闭的文件";
	private static final String COMMAND_CLEAR_ITEM = "清空选项";
	...
	public void initViews() {
		...
		int x = (screenWidth - FRAME_WIDTH) / 2;	//x轴位移
		...
		EventQueue.invokeLater(new Runnable(){
			public void run() {
				try {
					...
					String tcp_path = path + File.separator + "TCP" + File.separator;
					String udp_path = path + File.separator + "UDP"+ File.separator;
					String tcp_data_path = tcp_path + "数据负载提取结果"+ File.separator;
					String udp_data_path = udp_path + "数据负载提取结果"+ File.separator;
